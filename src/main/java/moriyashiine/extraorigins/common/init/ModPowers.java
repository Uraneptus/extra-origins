...
public class ModPowers {
	...
	public static final PowerFactory<?> MOB_NEUTRALITY = new PowerFactory<>(ExtraOrigins.id("mob_neutrality"), new SerializableData().add("entity_condition", ApoliDataTypes.ENTITY_CONDITION), data -> (type, entity) -> new MobNeutralityPower(type, entity, data.get("entity_condition"))).allowCondition();
